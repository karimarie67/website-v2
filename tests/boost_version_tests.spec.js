...
test.describe('Boost Website Version Tests', () => {
  ...
  test('Libraries page loads Latest version and switches to older version', async ({ page }) => {
    // Navigate to Libraries page
    await page.goto('https://www.boost.org/libs', { waitUntil: 'networkidle' });
    ...
    await page.waitForURL(/\/doc\/libs\/1_84_0/, { timeout: 15000 });
    await expect(page).toHaveURL('https://www.boost.org/doc/libs/1_84_0', 'URL should match version 1.84');
  ...
  test('Releases page loads Latest version and switches to older release', async ({ page }) => {
    // Navigate to Test page
    await page.goto('https://www.boost.org/users/history', { waitUntil: 'networkidle' });
    ...
    // Select older version (e.g., 1.84)
    await versionDropdown.selectOption({ label: '1.84.0' });
    await page.waitForURL('https://www.boost.org/users/history/version_1_84_0.html', { timeout: 15000 });
    await expect(page).toHaveURL('https://www.boost.org/users/history/version_1_84_0.html', 'URL should match version 1.84');
